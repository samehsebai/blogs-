...
export default function Artiste() {
  ...
  return (
    <div className="artiste">
        <span className="artistetitle">Modify Artiste</span>
        <div className="form_class">
        <form  className="artisteform" onSubmit={handleSubmit}>
        <label >nom</label>
            <input className="artisteinput" value={""} type="text" placeholder=" nom" 
             onChange={e=>setname(e.target.value)}
            />
            <label >date Naiss</label>
            <input className="artisteinput" value={""}type="date" placeholder=" dateNaiss" 
             onChange={e=>setdateNaiss(e.target.value)}
            />
            <label >date Deces</label>
            <input className="artisteinput" value={""} type="date" placeholder=" date Deces" 
            onChange={e=>setdateDeces(e.target.value)}
            />
            <label >nationalite</label>
            <input className="artisteinput" value={""} type="text" placeholder=" nationalite" 
            onChange={e=>setnationalite(e.target.value)}
            />
            <label >biographie</label>
            <input className="artisteinput" value={""}type="text" placeholder="biographie" 
